    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" method="post" action="../controllers/NoticiaController.php">
		    			<div class="form-group">
			    			<div class="col-xs-5">
			    				<input type="text" class="form-control" name="imagen" placeholder="Imagen" required autofocus>
			    			</div>
		    			</div>
		    			
		    			<div class="form-group">
			    			<div class="col-xs-5">
								<textarea class="form-control" name="titular" placeholder="Titular" rows="4" cols="50" required></textarea>
								<!--
		    			...
		    			<div class="form-group">
			    			<div class="col-xs-5">
								<textarea class="form-control" name="cuerpo" placeholder="Cuerpo" rows="4" cols="50" required></textarea>
								<!--
			    				<input type="text" class="form-control" name="cuerpo" placeholder="Cuerpo" required>
								-->
			    			</div>
		    			</div>
